...
{
	if (!(self = [self initWithName:@"internal-square" fragmentShaderName:@"Square.fs" geometryShaderName:nil vertexShaderName:@"Square.vs" baseURL:nil resourceManager:manager error:error])) return nil;
