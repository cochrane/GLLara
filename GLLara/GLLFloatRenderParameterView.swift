//
//  GLLFloatRenderParameterView.swift
//  GLLara
//
 ...
 */
@objc class GLLFloatRenderParameterView: NSView {
    @IBOutlet var parameterTitle: NSTextField? = nil
    @IBOutlet var parameterDescription: NSTextField? = nil
    @IBOutlet var parameterSlider: NSSlider? = nil
    @IBOutlet var parameterValueField: NSTextField? = nil
}
