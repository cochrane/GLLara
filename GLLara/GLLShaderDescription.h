 ...
 */
@property (nonatomic, copy, readonly) NSArray<NSString *> *parameterUniformNames;
@property (nonatomic, copy, readonly) NSArray<NSString *> *textureUniformNames;

/*
 * Defines that get passed to the shader compiler.
 */
@property (nonatomic, copy, readonly) NSDictionary<NSString *, NSString *> *defines;

/*
 * Uniforms that are not specified by models.
 */
@property (nonatomic, copy, readonly) NSArray<NSString *> *additionalUniformNames;

@property (nonatomic, copy, readonly) NSArray<NSString *> *allUniformNames;

/*
 * Mesh groups for which this shader should be used.
 */
@property (nonatomic, copy, readonly) NSSet<NSString *> *solidMeshGroups;
@property (nonatomic, copy, readonly) NSSet<NSString *> *alphaMeshGroups;
