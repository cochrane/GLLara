...
- (void)testTypicalModel
{
	...
	XCTAssertEqual(mesh.vertexFormat.offsetForBoneIndices, (NSUInteger) 52, @"Wrong offset");
	XCTAssertEqual(mesh.vertexFormat.offsetForBoneWeights, (NSUInteger) 60, @"Wrong offset");
